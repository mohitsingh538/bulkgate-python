...
if __name__ == '__main__':
    ...
    def send_transactional(app_id, app_token, sms_data):
        ...
        sender_id = sms_data['sender_id'] if 'sender_id' in sms_data else "gText"
        sender_id_value = sms_data['sender_id_value'] if 'sender_id_value' in sms_data else "Python"
